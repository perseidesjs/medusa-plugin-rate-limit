...
# [Documentation](https://docs.perseides.org/plugins/rate-limit/getting-started)
Access the documentation for the package, by clicking ["here"](https://docs.perseides.org/plugins/rate-limit/getting-started)